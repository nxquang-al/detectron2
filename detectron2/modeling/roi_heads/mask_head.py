...
def mask_rcnn_inference(pred_mask_logits, bo_mask_logits, bound_logits, bo_bound_logits, pred_instances):
    ...
    if cls_agnostic_mask:
        ...
        bound_probs_pred = bound_logits[indices, class_pred][:, None].sigmoid()
        bo_mask_probs_pred = bo_mask_logits[indices, class_pred][:, None].sigmoid()
        bo_bound_probs_pred = bo_bound_logits[indices, class_pred][:, None].sigmoid()
